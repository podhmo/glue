...
class StopOnFailTests(unittest.TestCase):
    ...
    def test_guard_return_true(self):
        ...
        result = target.chain(lambda c,x: c.unit(x*x)).guard(lambda c,x: x % 2 == 0)(StopOnFail(), 10)
    ...
    def test_guard_return_false(self):
        ...
        result = target.chain(lambda c,x: c.unit(x*x)).guard(lambda c,x: x % 2 == 0)(StopOnFail(), 11)
